...
(check-expect (contains? "Donald Duck" (cons "UBC" (cons "McGill" empty))) false)
...
(check-expect (map2 abs (list -7 12)) (list 7 12))
...
;; given pred and (list n1 n2 ...) apply pred on n if it produces true, n is included
...
(check-expect (filter2 false? (list false true false true)) (list false false))
